...
+ (void)showDefaultIndicatorAlertOnView:(UIView *)view withTitle:(NSString *)title {
...
+ (UIView *)contentViewFromType:(FVAlertType)type {
    ...
    switch (type) {
        ...
        case FVAlertTypeWarning:
        {
            ...
            break;
        case FVAlertTypeIndicator:
        {
            content.frame = CGRectMake(0, 0, kActivityIndicatorSize, kActivityIndicatorSize);
            UIActivityIndicatorView *indicatorView = [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleWhiteLarge];
            indicatorView.frame = content.bounds;
